# Insert sample data into LMS database
# Usage: .\insert-sample-data.ps1

$mysqlPath = "C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql.exe"

Write-Host "📊 Inserting sample data into lmsdb..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  • 4 Instructors"
    Write-Host "  • 5 Courses"
    Write-Host "  • 9 Course Sections"
    Write-Host "  • 9 Course Lectures"
    Write-Host "  • 7 Course Reviews"
    Write-Host ""
    Write-Host "Run 'dotnet run' to start the API and test with Swagger!"
} else {
